...
export default function Footer(){
  return <footer className="footer">
    <div><h3>SKI | Swedish Kitchen Installers</h3><p>We are the &quot;KEA&quot; to unlocking your new kitchen.</p><p className="muted">Serving the Kansas City metro and Lawrence area. Business contact details are coming soon.</p><p className="muted">IKEA<sup className="trademarkMark">&reg;</sup> is a registered trademark of Inter IKEA Systems B.V. SKI (Swedish Kitchen Installers) is an independent company and is not affiliated with, endorsed by, or sponsored by Inter IKEA Systems B.V.</p></div>

...
export default function Footer(){
  return <footer className="footer">
    <div><h3>SKI | Swedish Kitchen Installers</h3><p>We are the &quot;KEA&quot; to unlocking your new kitchen.</p><p className="muted">Serving the Kansas City metro and Lawrence area. Business contact details are coming soon.</p></div>
